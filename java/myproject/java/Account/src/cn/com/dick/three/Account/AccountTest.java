...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		double depositAmount;//deposit account read from user
		
		System.out.print("Enter debit amount for account1: ");//prompt
		depositAmount = input.nextDouble();//obtain user input
		
		System.out.printf("\nDebit %.2f to account1 balance\n\n", 
				depositAmount);//debit to account balance
		account1.debit(depositAmount);//debit to account1 balance
		...
		System.out.printf("\nadding %.2f to account2 balance\n\n", 
				depositAmount);//add to account balance
