...
<html>
 ...
 function requestactivity(){
	 $.ajax({
		 ...
		 //contentType:'application/jason;charset=utf-8',
		 data:'acId=4&acCreId=1133710501&acCreDate=1916-8-17 9:9&acDueDate=2016-8-19 9:9&acTitle=测试活动&acDesc=测试测试&acDocId=34132412&acDoc1Name=文件1&acDoc2Name=文件2&acDoc3Name=文件三',
		 success:function(data){
			 alert(data);
		 }
 ...
 function ceshi(){
	 $.ajax({
		 ...
		 contentType:'application/json;charset=utf-8',
		 data:'{"userId":"1233433","password":"3344trt"}',
		 success:function(data){
			 alert("成功");
		 }
 ...
 function ceshi2(){
	 $.ajax({
		 type:'post',
		 url:'<%=basePath%>queryMessagesAlread.action',
		 contentType:'application/json;charset=utf-8',
		 data:'{"recId":"1143710501"}',
		 success:function(data){
			 alert("成功"+data[0].notId);
		 }
  ...
  <body>
    ...
    <h1>测试</h1>
    <input type="button"  value="测试数据" onclick="ceshi2()">
  </body>
</html>
